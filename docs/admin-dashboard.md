---
title: Your WordPress admin (Yatra)
description: A simple map of the Yatra sidebar in WordPress—what each menu is for and where to learn more. No code required.
prev:
  text: Quick start
  link: /quick-start
next:
...
Visitors use your **theme** and Yatra’s templates: trip pages, search, **My account**, checkout, cart, and shortcodes/blocks. Those are covered in [Shortcodes](/shortcodes) and [Blocks & page builders](/elementor-integration).

## Next step

Pick one workflow and follow it end to end:

1. [Quick start](/quick-start) — wizard, first trip, first booking.  
2. [Trips & catalog](/tour-booking) — build the catalog you’ll sell.

When you’re ready for gateways and templates, use [Payments](/payment-settings) and [Email & notifications](/email-settings).
