...
| Module | Category | Settings page after enable |
| --- | --- | --- |
| Google Calendar Integration | Integrations | `yatra-google-calendar` |
| Additional Services | Sales | `yatra-additional-services` |
| Trip Consent | Operations | `yatra-trip-consent` |
| Email Automation | Marketing | `email-automation` |
| Dynamic Form Field | Bookings | `yatra-settings` |
| Advanced Discount | Marketing | (extends existing Discounts) |
| Mailchimp Integration | Marketing | `yatra-mailchimp` |
| Facebook Pixel | Marketing | `yatra-facebook-pixel` |
| Google Analytics 4 Enhanced | Marketing | `yatra-google-analytics` |
| Flexible Payments | Payments | `yatra-settings` |
| Scheduled Payments | Payments | `yatra-settings` |
| Dynamic Pricing | Sales | `dynamic-pricing` |
| Custom Landing Pages | Marketing | `yatra-settings` |
| Abandoned Booking Recovery | Marketing | `abandoned-recovery` |
